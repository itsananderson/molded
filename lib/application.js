    ...
    _.forEach(depNames, function(dep, index) {
        ...
        if (found) {
            ...
            if (found.value) {
                ...
                resolvedDeps.push(found.value = self.resolveAndCall(method, url, depParams, nextlessDeps, found));
            } else {
                resolvedDeps.push(self.resolveAndCall(method, url, depParams, nextlessDeps, found));
            }
        } else {
